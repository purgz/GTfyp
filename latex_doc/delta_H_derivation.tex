...
\Big[T^{R+}\left(p(1-p) + p(p+1)\right) \Big]
\end{aligned}
\end{equation}
...
\begin{equation} \label{delta_h_snowdrift}
\begin{aligned}
  \langle \Delta H_{RPS} \rangle &= \text{scaling ? } \sum_{i=1}^{N}\sum_{j=1}^{N}\sum_{k=1}^{N}\Big[ijk(T^{RP} + T^{RS} + T^{R+} + T^{PR} + T^{PS} + T^{P+} \\
...
\begin{equation}
\begin{aligned}
\langle \Delta H_{RPS} \rangle &= \text{scaling?} \int_{0}^{1}dx \int_{0}^{1-x} dy \int_{0}^{1-x-y}dz \Big[xyz(T^{RP} + T^{RS} + T^{R+} + T^{PR} + T^{PS} + T^{P+} \\
&+ T^{SR} + T^{SP} + T^{S+} + T^{+R} + T^{+P} + T^{+S}) \\
&- z(x - \frac{1}{N})(y + \frac{1}{N})T^{RP} - (x - \frac{1}{N})y(z + \frac{1}{N})T^{RS} - yz(x - \frac{1}{N})T^{R+} \\
&- z(x + \frac{1}{N})(y - \frac{1}{N})T^{PR} - x(y - \frac{1}{N})(z + \frac{1}{N})T^{PS} - xz(y - \frac{1}{N})T^{P+} \\
&- (x + \frac{1}{N})y(z - \frac{1}{N})T^{SR} - x(y + \frac{1}{N})(z - \frac{1}{N})T^{SP} - xy(z - \frac{1}{N})T^{S+} \\
&- yz(x + \frac{1}{N})T^{+R} - xz(y + \frac{1}{N})T^{+P} - xy(z + \frac{1}{N})T^{+S}\Big]
\end{aligned}
\end{equation}

...
\begin{aligned}
  ...
  k(1-i-j-k)(j-i)(T^{RP} - T^{PR}) + j(1-i-j-k)(k-i)(T^{RS} - T^{SR}) \\
  &+ i(1-i-j-k)(j-k)(T^{SP} - T^{PS}) + k(1-i-j-k)(T^{RP} + T^{PR}) + j(1-i-j-k)(T^{RS} + T^{SR}) \\
  &+ i(1-i-j-k)(T^{SP} + T^{PS}) + jk(-2i-k-j)(T^{R+} - T^{+R}) + ik(-2j-k-i)(T^{P+} - T^{+P}) \\
  &+ ij(-2k-i-j)(T^{S+} - T^{+S}) + 2jkT^{R+} + 2ikT^{P+} + 2ijT^{S+}\Big]
\end{aligned}
\end{equation}

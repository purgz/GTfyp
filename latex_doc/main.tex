...
\begin{equation}
    T^{R \rightarrow +}, T^{P \rightarrow +},T^{S \rightarrow +},T^{+ \rightarrow R}, T^{+ \rightarrow P}, T^{+ \rightarrow S}
\end{equation}

\begin{equation}
    T^{R \rightarrow +} = \text{insert}    
\end{equation}  
And the internal transitions between RPS

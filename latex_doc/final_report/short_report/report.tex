...
\begin{figure*}
\centering
\includegraphics[scale=0.3]{Figures/arps_time_series_standard.pdf}
...
\begin{figure*}
\centering
\includegraphics[scale=0.5]{Figures/spiral_in_time_series.pdf}
...
This can be approximated in the contnuous limit by the following integral where $x = i/N, y=j/N, z=k/N and q = 1-x-y-z$:

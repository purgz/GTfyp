...
and is an example of an anti-coordination game where unlike the famous prisoners dilemma, 
mutual cooperation is preferred over mutual defection.
The rows in the below payoff matrix correspond to cooperation and defection giving the payoff matrix:
...
The interior Nash equilbrium occurs at the mixed strategy $q^* = \frac{b-2c}{b-c}$

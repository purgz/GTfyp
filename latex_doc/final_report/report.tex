...
Should include a figure for RPS cyclic dynamics.

Add in the fixed points and stability for RPS.
...
Exact solutions for these integrals for the local update process
and also the critical population size for the local update process
defined as when $\langle \Delta H\rangle_{LU} = 0$.

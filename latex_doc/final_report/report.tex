...
\section{Fokker-Planck Approximation}

In the diffusion approximation, the master equation may be expanded to second order in $1/N$, yielding a Fokker--Planck equation of the form
...
\section{Drift of Coexistence Measures}
...
For the three-strategy subsystem, we consider the standard coexistence measure
\[
H_{\mathrm{RPS}} = - x y z .
\]

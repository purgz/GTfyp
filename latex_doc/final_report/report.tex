...
Introduction to evolutionary game theory \cite{evolution_maynard,evolution_pop_dynamics}

To understand the combined game, first must look at the single cases of rock paper scissors and Snowdrift.


Report focusses mostly on math, derivations and results, 
for more information about the simulation code and visualisation tools, see project readme, 
and readme in /source/simulation for an example of how to use the library to run 
custom game simulations. Also how to use the gui to interact and run some animations
and plots.
...
The snowdrift/hawk-dove game has also been intensely 
...
This work focusses on the composite game with the idea of combining snowdrift (SD) and rock-paper-scissors (RPS)
...
In this report I show that there 
...
altering the dynamics from the infinite N case depending on the 
relative critical population sizes. 
...
\begin{equation}
P = \text{master eq here}
\end{equation}

Expanding the probabilities and the transition probabilites to the 
second order taylor expansion, the master equation can be 
expanded 

For full derivation of the FPE for this system, see appendix.
...
Quick derivation and explanation of the $H_{SD}$ analytical result.
...
Table here of the exact values from the appendix.
